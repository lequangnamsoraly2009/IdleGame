...
Tính năng bổ sung:
* Với gói có tiết kiệm (giảm 5%) chỉ được mua số lượng nhất đinh mỗi ngày (ví dụ: 100/ngày).
* Vòng sáng xung quanh nút mua nhiều và nút mua gói sẽ nhấp nháy màu xanh lá cây
* Khi số lượng mua nhiều hoặc mua gói vượt quá giới hạn mỗi ngày thì nút mua sẽ bị vô hiệu hóa.
